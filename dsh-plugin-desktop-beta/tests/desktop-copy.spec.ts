...
describe('Desktop product copy', () => {
  ...
  it('separates Recovery Mode from checkpoint rollback', () => {
    ...
    for (const scope of ['2026/8/25 10:00:00', 'Profile', 'settings.yaml', 'OpenFox Home 目录补丁']) expect(confirmation).toContain(scope)
    ...
    expect(copy.confirmCreateDefaultDirectoryBody).toContain('全新的 OpenFox Home 环境')
