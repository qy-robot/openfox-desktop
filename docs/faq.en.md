...
No. The repository pins an unmodified official Harness checkout. The unified extended presentation installs a Desktop-owned root registration through the plugin/profile composition boundary while retaining the official slot occupants. It does not edit upstream source.
