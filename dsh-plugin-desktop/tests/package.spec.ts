...
describe('published package surface', () => {
  ...
  it('keeps active Profile preferences as the lazy source and serializes runtime mirrors', () => {
    ...
    expect(projectionSource).toContain('readonly mode: unknown')
    expect(projectionSource).toContain("openBrowser: false")
    expect(projectionSource).toContain("networkExposure: 'loopback'")
