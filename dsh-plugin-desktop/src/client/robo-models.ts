...
/** Replace the upstream provider catalog with OpenFox official-first model settings. */
export function applyRoboModels(ctx: ClientContext): void {
  ...
  ctx.effect(installRoboModelsStyles, 'dsh-plugin-desktop: OpenFox models styles')
