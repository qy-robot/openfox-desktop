...
.dshDesktopFrame[data-rightbar-fullscreen] .dshDesktopRightbarSurface { position: fixed; z-index: 900; inset: 0; width: 100%; height: 100%; background: var(--dsw-alias-bg-base); }
