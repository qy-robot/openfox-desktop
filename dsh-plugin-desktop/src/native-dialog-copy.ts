...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    installStableAlongsideBeta: 'Install the stable edition alongside DSH Desktop? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
  ...
  zh: {
    ...
    installStableAlongsideBeta: '是否同时安装稳定版？DSH Desktop 将继续保留。',
    download: '下载',
    later: '稍后',
