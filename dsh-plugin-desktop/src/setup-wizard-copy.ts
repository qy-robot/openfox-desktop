...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    ...
    aaIntro: 'Use Agents-Anywhere to access RoboCoding on this computer from your phone or a browser.',
    ...
    beta: 'Beta',
    title: 'Set up RoboCoding',
    profile: 'Profile',
    welcomeTitle: 'Welcome to RoboCoding',
    ...
    serviceBody: 'RoboCoding uses your signed-in account by default. No API key is required during first-time setup.',
    officialService: 'RoboCoding service',
    ...
    customModelsBody: 'You can later add another provider under Settings > Models, including its API key and service URL. RoboCoding will try to detect the protocol and model list automatically, and lets you edit them manually.',
    ...
    lanWarningBody: 'Anyone on the same local network who has the access link can use RoboCoding to operate this computer. Share the link only with people you trust. Connections use HTTPS; each device must install and trust the certificate provided by this computer.',
    ...
    communityMarketBody: 'The open market built into RoboCoding, including custom data sources.',
    ...
    startUsing: 'Start using RoboCoding',
    invalidState: 'Setup information could not be loaded. Close this window and try again.',
  },
  zh: {
    aaTitle: 'Agents-Anywhere',
    aaIntro: '通过 Agents-Anywhere，在手机或浏览器中访问这台电脑上的 RoboCoding。',
    aaDisabled: '关闭手机连接',
    ...
    lanWarningBody: '同一局域网中，持有访问链接的人可以通过 RoboCoding 操作这台电脑。请仅与可信任的人共享链接。连接使用 HTTPS；访问设备需要安装并信任本机提供的证书。',
    confirmLan: '开启局域网访问',
    cancelLan: '保持仅本机访问',
    marketTitle: '选择插件市场',
    ...
    communityMarketBody: 'RoboCoding 内置的开放市场，并支持自定义数据源。',
    dshMarket: '社区插件市场',
